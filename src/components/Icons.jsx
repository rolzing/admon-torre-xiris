...
export function IconoLinkedIn({ className = '' }) {
  return (
    <svg viewBox="0 0 24 24" width="1em" height="1em" className={className} fill="currentColor">
...
export function IconoWeb({ className = '' }) {
  return (
    <svg {...base} width="1em" height="1em" className={className}>
      <circle cx="12" cy="12" r="10" />
