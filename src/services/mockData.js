...
export const fondoComun = {
  ...
  // (sólo los últimos 4 dígitos, ej. ***1233) para transparencia sin
  // exponer datos sensibles completos. Se publica en la página de inicio.
  cuentaBancaria: '0104 9223 2345 1233',
